...
public class FragmentTab2  extends Fragment
{
    ...
    private static final int HISTORY_SIZE = 180;            // number of points to plot in history
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        s1HistorySeries = new SimpleXYSeries("Sun");
        ...
        sHistoryPlot.setRangeBoundaries(0, 90, BoundaryMode.AUTO);
        ...
        */
        ...
        sHistoryPlot.setDomainLabel("Az");
        sHistoryPlot.getDomainLabelWidget().pack();
        sHistoryPlot.setRangeLabel("Alt");
    ...
    public void onSensorChanged() {
        ...
        if (s1HistorySeries.size() > HISTORY_SIZE) {
